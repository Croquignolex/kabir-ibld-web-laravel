@php
    ...
    $is_a_user_connected = $user->role->type === \App\Models\Role::USER;
    $avatar_route = $is_a_user_connected ? route('account.avatar') : route('admin.account.avatar');
    $password_route = $is_a_user_connected ? route('account.password') : route('admin.account.password');
@endphp
            ...
            <div class="profile-content-right py-5">
                ...
                <div class="tab-content px-3 px-xl-5" id="myTabContent">
                    ...
                    <div class="tab-pane fade" id="avatar" role="tabpanel" aria-labelledby="avatar-tab">
                        <div class="mt-4">
                            <form method="POST" action="{{ $avatar_route }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}
                    ...
                    <div class="tab-pane fade" id="password" role="tabpanel" aria-labelledby="password-tab">
                        <div class="mt-4">
                            <form method="POST" action="{{ $password_route  }}">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}
                                @include('partials.form.input', [
